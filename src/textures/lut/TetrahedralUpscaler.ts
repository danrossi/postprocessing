 ...
 * @param d - A tetrahedron vertex.
 * @return The volume.
 */

function calculateTetrahedronVolume(a: Float32Array, b: Float32Array, c: Float32Array, d: Float32Array): number {
 ...
 *
 * @param data - The source data (RGBA).
 * @param size - The size of the source texture.
 * @param x - The X coordinate.
 * @param y - The Y coordinate.
 * @param z - The Z coordinate.
 * @param color - A container for the sampled color.
 */

function sample(data: ArrayLike<number>, size: number, x: number, y: number, z: number, color: Float32Array): void {
...
function tetrahedralSample(data: ArrayLike<number>, size: number,
	u: number, v: number, w: number, color: Float32Array): void {
